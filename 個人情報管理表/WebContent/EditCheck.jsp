...
<input type="hidden" name="categoryid" value="<%=categoryid%>">
 <ul>
  <li style="list-style: none; display: inline-block;"><input  formaction="http://localhost:8080/個人情報管理表/EditCommitBL" type="submit" name="send" value="編集" style="width:100px;height:25px"></li>
